...
from config.utils import add_form_error_to_session, get_loa_document_bundle, \
                ...
                "sub_steps": [
                    {
                        ...
                        "status": "Complete" if submission.get("contact") and submission[
                            "contact"].get("organisation") else "Not Started",
                    }
                ],
            },
        ]
