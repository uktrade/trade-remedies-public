!function (t, e) {
    ...
    (function (t) {
        ...
        "defineProperty" in Object && function () {
            ...
            var o = String(e), i = "value" in n || "writable" in n, s = "get" in n && typeof n.get,
        ...
        "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
            value: function (e) {
                var n, t = Array, o = Object, i = o.prototype, s = t.prototype, r = function r() {
                    }, a = i.toString, l = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag,
                    c = Function.prototype.toString, u = function u(t) {
                        try {
                            return c.call(t), !0
                        } catch (e) {
                            return !1
                ...
                var d = s.slice, h = s.concat, p = s.push, f = Math.max, m = this;
        ...
        "DOMTokenList" in this && (!("classList" in (t = document.createElement("x"))) || !t.classList.toggle("x", !1) && !t.className) || ("DOMTokenList" in (e = this) && e.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (e.DOMTokenList = function () {
            ...
            return function (i, s) {
                var r = this, a = [], l = {}, c = 0, t = 0, e = function (t) {
                    n(r, t, function () {
                        return d(), a[t]
                    }, !1)
                }, u = function () {
        ...
        "Element" in this && "HTMLElement" in this || function () {
            if (!window.Element || window.HTMLElement) {
                ...
                var t, e = document.appendChild(document.createElement("body")),
                    ...
                    a = Element.prototype = n.appendChild(n.createElement("*")), l = {}, c = function (t, e) {
                        var n, o, i, s = t.childNodes || [], r = -1;
        ...
        "document" in this && "classList" in document.documentElement && "Element" in this && "classList" in Element.prototype && ((e = document.createElement("span")).classList.add("a", "b"), e.classList.contains("b")) || function (t) {
            ...
            var h = function (t, l, c) {
                d(t.prototype, l, function () {
                    ...
                    if (e[n]) return t;
                    if (!(e[n] = !0) === u) {
                        for (var o, i = h.mirror || document.createElement("div"), s = i.childNodes, r = s.length, a = 0; a < r; ++a) if (s[a]._R === e) {
                            o = s[a];
                            break
                        }
        ...
        var n = t.querySelector("." + this.sectionButtonClass), o = t.querySelector("." + this.sectionHeadingClass),
            i = t.querySelector("." + this.sectionSummaryClass), s = document.createElement("button");
        ...
        var h = document.createElement("span"), p = document.createElement("span");
        if (p.classList.add(this.upChevronIconClass), d.appendChild(p), h.classList.add(this.sectionShowHideTextClass), d.appendChild(h), s.appendChild(l), s.appendChild(this.getButtonPunctuationEl()), null != i) {
            var f = document.createElement("span"), m = document.createElement("span");
            m.classList.add(this.sectionSummaryFocusClass), f.appendChild(m);
            for (var b = 0, v = i.attributes.length; b < v; ++b) {
                var y = i.attributes.item(b).nodeName, g = i.attributes.item(b).nodeValue;
                f.setAttribute(y, g)
            }
        ...
        var n = e.querySelector("." + this.upChevronIconClass),
            ...
            i = e.querySelector("." + this.sectionButtonClass), s = t ? "Hide" : "Show",
    ...
    }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}), function (s) {
        !function (t) {
            ...
            if ("undefined" != typeof document && "undefined" != typeof window) {
                ...
                window.Event = Window.prototype.Event = function (t, e) {
                    ...
                    if ("createEvent" in document) {
                        ...
                        var o = !(!e || e.bubbles === s) && e.bubbles, i = !(!e || e.cancelable === s) && e.cancelable;
                    ...
                    var r = this, t = arguments[0], e = arguments[1];
                    ...
                    r._events || (r._events = {}), r._events[t] || (r._events[t] = function (t) {
                        var e, n = r._events[t.type].list, o = n.slice(), i = -1, s = o.length;
    ...
    i.prototype.init = function () {
        ...
        var t = this.$module, e = this.$summary = t.getElementsByTagName("summary").item(0),
        ...
        var t = this.$module, e = this.$textarea, n = this.$countMessage;
        if (e && n) {
        ...
        if (e) {
            ...
            if (n.length) {
                ...
                var i = o.getBoundingClientRect().top, s = t.getBoundingClientRect();
